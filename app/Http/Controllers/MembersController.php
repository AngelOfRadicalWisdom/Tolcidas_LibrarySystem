  ...
  public function __construct()
    ...
    public function update(Request $request){
    	$rules = [
            ...
            'member_nid_no' => 'required|min:10|max:17'
            ];
        $messages = [
            ...
            'member_nid_no.required' => 'School ID is required',
            'member_nid_no.min' => 'School ID cannot be less than 10 characters',
            'member_nid_no.max' => 'School ID cannot be greater than 17 characters'
    ...
    {   
    	$rules = [
            ...
            'member_contact' => 'required|min:11',
            'member_nid_no' => 'required|unique:members|min:10|max:17'
            ];
        $messages = [
            'member_name.required' => 'Member name is required!',
            'member_name.min' => 'Member name is Invalid!',
            ...
            'member_contact.min' => 'Invalid Mobile Number',
            'member_nid_no.required' => 'School ID is required',
            'member_nid_no.unique' => 'School ID already used in another account!',
            'member_nid_no.min' => 'School ID number cannot be less than 10 characters',
            'member_nid_no.max' => 'School ID number cannot be greater than 17 characters'
